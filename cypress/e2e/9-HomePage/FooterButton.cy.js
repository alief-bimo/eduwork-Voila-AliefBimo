...
describe('Validate the function of buttons on footer', () => {
    ...
    it('Should verify About voilà.id button', () => {
        cy.wait(8000)
        cy.get(':nth-child(2) > :nth-child(2) > .rdkhex7').click({force: true})
    ...
    it('Should verify Our Boutiques button', () => {
        cy.wait(8000)
        cy.get(':nth-child(2) > :nth-child(3) > .rdkhex7').click({force: true})
    ...
    it('Should verify Our Blog button', () => {
        cy.wait(8000)
        cy.get(':nth-child(2) > :nth-child(4) > .rdkhex7').click({force: true})
    ...
    it('Should verify About Our Promotions button', () => {
        cy.wait(8000)
        cy.get(':nth-child(2) > :nth-child(5) > .rdkhex7').click({force: true})
    ...
    it('Should verify Programs & Partnership button', () => {
        cy.wait(8000)
        cy.get(':nth-child(6) > .rdkhex7').click({force: true})
    ...
    it('Should verify Shop by Request button', () => {
        cy.wait(8000)
        cy.get(':nth-child(7) > .rdkhex7').click({force: true})
    ...
    it('Should verify voilà.id x Kaya Leathers button', () => {
        cy.wait(8000)
        cy.get(':nth-child(9) > .rdkhex7').click({force: true})
        cy.wait(4000)
    ...
    it('Should verify Contact Us button', () => {
        cy.wait(8000)
        cy.get(':nth-child(3) > :nth-child(2) > .rdkhex7').click({force: true})
    ...
    it('Should verify Terms & Conditions button', () => {
        cy.wait(8000)
        cy.get(':nth-child(3) > :nth-child(4) > .rdkhex7').click({force: true})
    ...
    it('Should verify Privacy Policy button', () => {
        cy.wait(8000)
        cy.get(':nth-child(3) > :nth-child(5) > .rdkhex7').click({force: true})
        cy.wait(4000)
    ...
    //     cy.wait(8000)
    //     cy.get(':nth-child(3) > :nth-child(3) > .rdkhex7').click({force: true})
    //     cy.wait(4000)
    ...
    //     cy.wait(8000)
    //     cy.get(':nth-child(8) > .rdkhex7').click({force: true})
    //     cy.wait(4000)
    //     //cy.url().should('not.be.empty');
    //     cy.url().should('contain','https://ctlyst.freshteam.com/jobs')
